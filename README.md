...
11) Настройте пограничные маршрутизаторы. Нужно настроить адресацию и проверить сетевую связность внутри ЛВС и доступность шлюза провайдера. 

13) Нужно настроить маршрутизацию ospf: интерфейсы в сторону ASA в зоне 1, между собой в зоне 0.  
